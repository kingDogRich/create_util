 ...
 *
 */
public class CreateDModelFile extends CreateFileBase {

	protected final static String ENTITY = "db.model.entity";
	protected final static String packageName = CreateFileBase.packagePrefix+"."+ENTITY;
...
//					String column_type = f.getColumn_type();
				...
				content += "\r\n" + "";
				content += "\r\n" + "/**";
				content += "\r\n" + " * " + entityNameC + "	" + table_comment + "DBModel";
				content += "\r\n" + " */";
				//content += "\r\n" + "@XmlRootElement(name = \"" + table_name + "\")";
				//content += "\r\n" + "public class " + className + flg + " extends BaseDBModel {";
				...
				System.out.println("CreateDModelFile success");
			} catch (IOException e) {
...
//		System.out.println(fieldInfosList.get(0));
		new CreateDModelFile().create("student");
	}
